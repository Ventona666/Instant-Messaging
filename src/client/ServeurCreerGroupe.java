...
public class ServeurCreerGroupe {
	...
	private void buildCenterPanel() {
		...
		GroupLayout gl_mainPanel = new GroupLayout(centerPanel);
		gl_mainPanel
				.setHorizontalGroup(gl_mainPanel.createParallelGroup(Alignment.TRAILING)
						.addGroup(gl_mainPanel.createSequentialGroup().addGap(22).addComponent(userSelectedLabel)
								.addContainerGap(378, Short.MAX_VALUE))
						.addGroup(
								gl_mainPanel.createSequentialGroup().addContainerGap(180, Short.MAX_VALUE)
										.addComponent(
												scrollPane, GroupLayout.PREFERRED_SIZE, 185, GroupLayout.PREFERRED_SIZE)
										.addGap(152))
						.addGroup(gl_mainPanel.createSequentialGroup().addGap(50)
								...
								.addGroup(gl_mainPanel.createParallelGroup(Alignment.LEADING)
										...
										.addGroup(gl_mainPanel.createParallelGroup(Alignment.TRAILING)
												...
												.addComponent(choisirUserButton, GroupLayout.PREFERRED_SIZE, 205,
														GroupLayout.PREFERRED_SIZE)))
								.addGap(140))
						.addGroup(gl_mainPanel.createSequentialGroup().addContainerGap(391, Short.MAX_VALUE)
		...
		gl_mainPanel.setVerticalGroup(gl_mainPanel.createParallelGroup(Alignment.LEADING)
				.addGroup(gl_mainPanel.createSequentialGroup().addGap(35)
		...
		centerPanel.setLayout(gl_mainPanel);
